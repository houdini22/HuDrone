...
QT_MOC_LITERAL(1, 11, 12), // "myTextEdited"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 11), // "MyLineEdit*"
QT_MOC_LITERAL(4, 37, 16), // "emitMyTextEdited"
QT_MOC_LITERAL(5, 54, 4) // "text"

    },
    "MyLineEdit\0myTextEdited\0\0MyLineEdit*\0"
    "emitMyTextEdited\0text"
};
...
void MyLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->myTextEdited((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->myTextEdited((*reinterpret_cast< MyLineEdit*(*)>(_a[1]))); break;
        case 2: _t->emitMyTextEdited((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (MyLineEdit::*)(QString , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLineEdit::myTextEdited)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyLineEdit::*)(MyLineEdit * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLineEdit::myTextEdited)) {
                *result = 1;
                return;
            }
...
// SIGNAL 0
void MyLineEdit::myTextEdited(QString _t1, QString _t2)
{
...
// SIGNAL 1
void MyLineEdit::myTextEdited(MyLineEdit * _t1)
{
