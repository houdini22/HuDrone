...
WizardAddProfilePage6::WizardAddProfilePage6(Config * configuration, Receivers * receivers) : QWizardPage(nullptr) {
    ...
    setTitle("Enter DISARMING engine radio values.");
...
void WizardAddProfilePage6::renderArming() {
...
void WizardAddProfilePage6::slotMyPushButton(MyPushButton * button) {
    this->addArmingDisarmingRow(button->getParameter("action"), button->getParameter("tab"), true, 0, 0);
}

void WizardAddProfilePage6::addArmingDisarmingRow(QString action, QString tabNum, bool addToConfig, int timeValue, int value) {
...
void WizardAddProfilePage6::slotMyPushButtonDelete(MyPushButton * button) {
...
void WizardAddProfilePage6::slotMyTextEdited(MyLineEdit * input) {
