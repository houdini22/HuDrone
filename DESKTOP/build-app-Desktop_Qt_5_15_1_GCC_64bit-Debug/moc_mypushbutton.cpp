...
QT_MOC_LITERAL(1, 13, 10), // "myReleased"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 13), // "MyPushButton*"
QT_MOC_LITERAL(4, 39, 14) // "emitMyReleased"

    },
    "MyPushButton\0myReleased\0\0MyPushButton*\0"
    "emitMyReleased"
};
...
void MyPushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->myReleased((*reinterpret_cast< MyPushButton*(*)>(_a[1]))); break;
        case 1: _t->emitMyReleased(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyPushButton::myReleased)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyPushButton::myReleased(MyPushButton * _t1)
{
