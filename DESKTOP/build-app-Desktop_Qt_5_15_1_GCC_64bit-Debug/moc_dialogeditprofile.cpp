...
#include <memory>
#include "../app/ui/dialogeditprofile.h"
...
QT_MOC_LITERAL(4, 52, 23) // "slotThrottleStepsEdited"

    },
    "DialogEditProfile\0textEdited\0\0"
    "myComboBoxTextChanged\0slotThrottleStepsEdited"
};
...
void DialogEditProfile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: { int _r = _t->slotThrottleStepsEdited((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])));
